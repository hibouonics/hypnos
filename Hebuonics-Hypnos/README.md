# Hebuonics Hypnos Firmware

Embedded firmware and hardware-interface code for **Hypnos**, a Hebuonics
...
Hebuonics-Hypnos/
├── firmware/
│   ├── hypnos.py          # Main Hebuonics Hypnos driver
...
Hebuonics-owned code in this repository is marked as proprietary under the root
`LICENSE` unless Hebuonics chooses a different release license later.
